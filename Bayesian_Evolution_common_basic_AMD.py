    ...
    def buy(self):
        ...
        for t in range(0, l, self.skip):
            ...
            if action == 1 and initial_money >= close[t]:
                ...
                states_buy.append(t)
                print(
                    'time_frame %d: buy %d units at price %f, total balance %f'
                ...
                try:
                    ...
                    invest = 0
                print(
                    'time_frame %d, sell %d units at price %f, investment %f %%, total balance %f,'
        ...
        print(
            '\ntotal gained %f, total investment %f %%, buy %s , sell %s, count %s '
            % (initial_money - starting_money, invest, len(states_buy), len(states_sell), len(states_buy) + len(states_sell))
        )
